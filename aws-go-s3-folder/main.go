...
import (
	...
	"github.com/kulado/kulado-aws/sdk/go/aws/s3"
	"github.com/kulado/kulado/sdk/go/kulado"
	"github.com/kulado/kulado/sdk/go/kulado/asset"
)

func main() {
	kulado.Run(func(ctx *kulado.Context) error {
...
func publicReadPolicyForBucket(bucketName kulado.ID) (interface{}, error) {
