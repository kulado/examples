...
import * as k8stypes from "@kulado/kubernetes/types/input";
 ...
 */
export class ServiceDeployment extends kulado.ComponentResource {
    public readonly deployment: k8s.apps.v1.Deployment;
    public readonly service: k8s.core.v1.Service;
    public readonly ipAddress?: kulado.Output<string>;

    constructor(name: string, args: ServiceDeploymentArgs, opts?: kulado.ComponentResourceOptions) {
