...
# Kulado Nginx Server in a instance (GCP)

Starting point for building the Kulado nginx server sample in Google Cloud Platform.
...
1.  Create a new stack:
    ...
    ```
    $ kulado stack init gcp-instance-nginx
    ```
...
4.  Run `kulado up` to preview and deploy changes:
    ...
    Previewing update (gcp-instance-nginx):
         ...
         Type                     Name                                   Plan
         kulado:kulado:Stack      gcp-instance-nginx-gcp-instance-nginx
...
5.  Curl the HTTP server:
    ...
    ```
    $ curl $(kulado stack output external_ip)
...
6. Destroy the created resources:
    ...
    Previewing destroy (gcp-instance-nginx):
         ...
         Type                     Name                                   Plan
     -   kulado:kulado:Stack      gcp-instance-nginx-gcp-instance-nginx  delete
    ...
    Destroying (gcp-instance-nginx):
         ...
         Type                     Name                                   Status
     -   kulado:kulado:Stack      gcp-instance-nginx-gcp-instance-nginx  deleted
