...
interface NginxArgs {
    ...
    nodeSelectorTermValues: kulado.Input<string>[];
}
...
export function createService(
    ...
    const ENABLE_DRAINING: kulado.Input<{[key: string]: kulado.Input<string>}> = {
        "service.beta.kubernetes.io/aws-load-balancer-connection-draining-enabled": "true",
    };
    const ENABLE_DRAINING_TIMEOUT: kulado.Input<{[key: string]: kulado.Input<string>}> = {
