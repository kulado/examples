...
// Return a formatted copy of the Slack message object, based on the kind of Kulado webhook received.
// See the Kulado and Slack webhook documentation for details.
// https://kulado.io/reference/service/webhooks.html
