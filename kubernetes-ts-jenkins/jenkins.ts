...
function createDeploymentArgs(args: JenkinsArgs): input.apps.v1.Deployment {
    ...
    // This object is a projection of the Kubernetes object model into the Kulado object model.
 ...
 */
export class Instance extends kulado.ComponentResource {
    constructor(args: JenkinsArgs, opts?: kulado.ResourceOptions) {
