...
let lambda = new aws.lambda.Function("mylambda", {
    ...
    code: new kulado.asset.AssetArchive({
        ".": new kulado.asset.FileArchive(dotNetApplicationPublishFolder),
    }),
    timeout: 300,
...
let invokePermission = new aws.lambda.Permission("api-lambda-permission", {
    ...
    sourceArn: kulado.interpolate `${deployment.executionArn}*/*`,
});

// Export the https endpoint of the running Rest API
export let endpoint = kulado.interpolate `${deployment.invokeUrl}${stageName}`;
