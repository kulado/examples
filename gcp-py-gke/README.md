...
Ensure you have [Python 3](https://www.python.org/downloads/) and [the Kulado CLI](https://kulado.io/install).
...
2. Set the required configuration variables for this program:
   ...
   ```bash
   $ kulado config set node_count 5
   $ kulado config set node_machine_type n1-standard-2
   ```
...
3. Deploy everything with the `kulado up` command. This provisions all the GCP resources necessary, including
   ...
   This will show you a preview, ask for confirmation, and then chug away at provisioning your cluster:
    ...
    Performing changes:
         ...
         Type                            Name          Plan
     +   kulado:kulado:Stack             gcp-py-dev    create
     +   ├─ gcp:container:Cluster        gke-cluster   create
     +   ├─ kulado:providers:kubernetes  gkeK8s        create
