...
1. Perform the deployment:
    ...
    Performing changes:
     ...
     +   kulado:kulado:Stack                          azure-mean-azure-mean  created     1 warning
     ...
     +   ├─ kulado:providers:kubernetes               aksK8s                 created
    ...
    Permalink: https://app.kulado.com/hausdorff/azure-mean/updates/1
    ```
    ...
    ```sh
    $ curl -sL $(kulado stack output frontendAddress) | grep "<title>"
