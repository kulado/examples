...
`kulado.github.io`. The nginx configuration is contained in the file `default.conf` in this
...
Performing changes:
 ...
 +   kulado:kulado:Stack            data-from-s3-s3-kube  created
...
Permalink: https://app.kulado.com/hausdorff/s3-kube/updates/1
```
...
at `google.com`. If you're on macOS you can run `sed -i bak "s/kulado.github.io/google.com/g"
default.conf`
...
Running `kulado up` would actually attempt to achieve these results.
...
[rollout]: https://github.com/kulado/examples/tree/master/kubernetes-ts-configmap-rollout
